...
simulation_test <- function(simtime, mutualism_pars1, mutualism_pars2){
  ...
  while (timeval1 < simtime & timeval2 < simtime){
    rates1 <- update_rates_mutualism(Mt = Mt_1,
                                    status_p = status_p1,
                                    status_a = status_a1,
                                    mutualism_pars = mutualism_pars1,
                                    island_spec = island_spec1)
    rates2 <- update_rates_mutualism(Mt = Mt_2,
                                     status_p = status_p2,
                                     status_a = status_a2,
    ...
    if (timeval1 <= simtime & timeval2 <= simtime){
      ...
      updated_state1 <- sim_update_state_mutualism(timeval = timeval1,
                                                  simtime = simtime,
      ...
      updated_state2 <- sim_update_state_mutualism(timeval = timeval2,
                                                   simtime = simtime,
...
stt_list <- simulation_test(simtime = 1,
