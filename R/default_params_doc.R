...
#'
#' @param simtime Numeric defining the length of the simulation in time units.
...
#' @param mutualism_pars A named list containing the model parameters as
...
#' @param plot_sims \code{Default = TRUE} It plots species-through-time (STT)
...
#'   of species.
#' @param stt_table Matrix with number of species at each time step. The first
